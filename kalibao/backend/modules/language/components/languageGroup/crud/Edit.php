...
class Edit extends \kalibao\common\components\crud\Edit
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setCreateTitle(Yii::t('kalibao.backend', 'language_language_group_create_title'));
        $this->setUpdateTitle(Yii::t('kalibao.backend', 'language_language_group_update_title'));
