...
<td class="td-action">
    ...
    <?php endif; ?>
    <?php if (Yii::$app->user->canMultiple([$this->context->getActionControllerPermission('view'), 'permission.update:*'])): ?>
    ...
    <a href="<?= Url::to(['translate'] + $row->getPk()); ?>" class="btn btn-sm btn-default btn-translate disabled" title="<?= Yii::t('kalibao', 'btn_translate'); ?>">
