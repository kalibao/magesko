...
class ListGrid extends \kalibao\common\components\crud\ListGrid
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setTitle(Yii::t('kalibao.backend', 'mail_mail_template_list_title'));
        ...
        $this->setGridHeadFilters([
            new InputField([
                ...
                'options' => [
                    ...
                    'data-text' => !empty($model->mail_template_group_id) ? MailTemplateGroupI18n::findOne([
                        'mail_template_group_id' => $model->mail_template_group_id,
                        'i18n_id' => $language
                    ])->title : '',
                ]
            ]),
            new InputField([
                'model' => $model,
                'attribute' => 'mail_template_i18n_object',
            ...
            new InputField([
                'model' => $model,
                'attribute' => 'mail_template_i18n_message',
                'type' => 'activeTextInput',
                    'options' => [
                    'class' => 'form-control input-sm',
                    'placeholder' => Yii::t('kalibao', 'input_search'),
