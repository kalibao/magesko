...
<?php if (! empty($crudList->gridHeadFilters)): ?>
    <tr class="head-filters form-inline">
        <td class="td-search">
            <a href="<?= Url::to(['list'] + (isset($crudList->requestParams['modal']) ? ['modal' => $crudList->requestParams['modal']] : [])); ?>" class="btn btn-default btn-search" title="<?= Yii::t('kalibao', 'btn_search'); ?>">
