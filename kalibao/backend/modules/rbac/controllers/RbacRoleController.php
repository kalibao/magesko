...
class RbacRoleController extends Controller
{
    ...
    protected $crudModelsClass = [
        'main' => 'kalibao\common\models\rbacRole\RbacRole',
        'i18n' => 'kalibao\common\models\rbacRole\RbacRoleI18n',
        'filter' => 'kalibao\backend\modules\rbac\models\rbacRole\crud\ModelFilter'
    ];
    ...
    protected $crudComponentsClass = [
        'edit' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\Edit',
        'list' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\ListGrid',
        'listFields' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\ListGridRow',
        'listFieldsEdit' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\ListGridRowEdit',
        'exportCsv' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\ExportCsv',
        'translate' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\Translate',
        'setting' => 'kalibao\backend\modules\rbac\components\rbacRole\crud\Setting',
    ];
