...
class Edit extends \kalibao\common\components\crud\Edit
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setCreateTitle(Yii::t('kalibao.backend', 'cms_simple_menu_create_title'));
        $this->setUpdateTitle(Yii::t('kalibao.backend', 'cms_simple_menu_update_title'));
        ...
        $items[] = new InputField([
            ...
            'options' => [
                ...
                'maxlength' => true,
                'placeholder' => $models['main']->getAttributeLabel('position'),
            ]
        ]);
        ...
        $items[] = new InputField([
            ...
            'options' => [
                'class' => 'form-control input-sm',
                'maxlength' => true,
                'placeholder' => $models['main']->getAttributeLabel('url'),
            ]
        ]);
