...
class ListGrid extends \kalibao\common\components\crud\ListGrid
{
    ...
    public function init()
    {
        ...
        if (isset($this->requestParams['mode']) && $this->requestParams['mode'] == 'explorer') {
            $this->setId($this->getId() . '_explorer');
        }
        ...
        // set titles
        $this->setTitle(Yii::t('kalibao.backend', 'cms_image_list_title'));
        ...
        $this->setGridHeadFilters([
            new InputField([
                'model' => $model,
                'attribute' => 'cms_image_i18n_title',
            ...
            new InputField([
                ...
                'options' => [
                    ...
                    'data-text' => !empty($model->cms_image_group_id) ? CmsImageGroupI18n::findOne([
                        'cms_image_group_id' => $model->cms_image_group_id,
                        'i18n_id' => $language
                    ])->title : '',
                ]
            ]),
