...
class CategoryI18n extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'category_id' => Yii::t('kalibao.backend','id of the translated category'),
            'i18n_id' => Yii::t('kalibao.backend','id of the language'),
            'title' => Yii::t('kalibao.backend','translation for the title of the category'),
            'description' => Yii::t('kalibao.backend','translation for the description of the category'),
        ];
    }
