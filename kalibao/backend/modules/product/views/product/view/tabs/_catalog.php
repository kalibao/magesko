            ...
            <div class="col-md-6">
                ...
                <?php if (!empty($component->items['link_brand_product']->data)): ?>
                    <?= call_user_func_array([
                        ...
                        $component->items['link_brand_product']->type
                    ], [
                        $component->items['link_brand_product']->model,
                        $component->items['link_brand_product']->attribute,
                        $component->items['link_brand_product']->data,
                        $component->items['link_brand_product']->options
                    ]); ?>
                <?php else: ?>
                    <?= call_user_func_array([
                        '\kalibao\common\components\helpers\Html',
                ...
                <?php if (!empty($component->items['link_product_test']->data)): ?>
                    <?= call_user_func_array([
                        '\kalibao\common\components\helpers\Html',
                        $component->items['link_product_test']->type
                    ], [
                        $component->items['link_product_test']->model,
                        $component->items['link_product_test']->attribute,
                        $component->items['link_product_test']->data,
                        $component->items['link_product_test']->options
                    ]); ?>
                <?php else: ?>
                    <?= call_user_func_array([
                        '\kalibao\common\components\helpers\Html',
            ...
            <div class="col-md-6">
                <fieldset>
                    <legend>
                        ...
                        <a class="btn btn-primary btn-xs" id="open-all">
                            <i class="fa fa-expand"></i></a>
                        <a class="btn btn-primary btn-xs" id="close-all">
