    ...
    public function init()
    {
        ...
        $items['available_date'] = new InputField([
            ...
            'options'   => [
                ...
                'rel'         => (isset($models['main']->available_date)) ?
                    Yii::$app->formatter->asDate($models['main']->available_date,
                        I18N::getDateFormat(I18N::DATE_FORMAT, 'datepicker')) :
                    date('Y-m-d')
            ]
        ]);
        ...
        $items['tax_id'] = new InputField([
            ...
            'options'   => [
                ...
                'data-allow-clear' => 1,
                'data-placeholder' => Yii::t('kalibao', 'input_select'),
                'data-text'        => !empty($models['main']->tax_id) ? TaxI18n::findOne([
                    'tax_id' => $models['main']->tax_id,
                    'i18n_id' => $language
                ])->name : '',
            ]
        ]);
