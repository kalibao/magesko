            ...
            <table class="table text-center">
                ...
                <?php foreach($component->models['main']->variantList as $variant): ?>
                    <tr class="top-border-bold">
                        ...
                        <td><input class="form-control input-sm date-picker" type="text" name="discount[<?= $variant->discount->id ?>][start_date]" value="<?= Yii::$app->formatter->asDate($variant->discount->start_date, I18N::getDateFormat(I18N::DATE_FORMAT)) ?>"/></td>
                        <td><input class="form-control input-sm date-picker" type="text" name="discount[<?= $variant->discount->id ?>][end_date]" value="<?= Yii::$app->formatter->asDate($variant->discount->end_date, I18N::getDateFormat(I18N::DATE_FORMAT)) ?>"/></td>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control input-sm date-picker" type="text" name="discount[<?= $variant->discount->id ?>][start_date_vip]" value="<?= Yii::$app->formatter->asDate($variant->discount->start_date_vip, I18N::getDateFormat(I18N::DATE_FORMAT)) ?>"/></td>
                        <td><input class="form-control input-sm date-picker" type="text" name="discount[<?= $variant->discount->id ?>][end_date_vip]" value="<?= Yii::$app->formatter->asDate($variant->discount->end_date_vip, I18N::getDateFormat(I18N::DATE_FORMAT)) ?>"/></td>
                        <td><input class="form-control input-sm discount-final-price" type="text" disabled/></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
