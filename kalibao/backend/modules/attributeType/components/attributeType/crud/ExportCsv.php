...
namespace kalibao\backend\modules\attributeType\components\attributeType\crud;
 ...
 * Class ExportCsv
 *
 * @package kalibao\backend\modules\attributeType\components\attributeType\crud
 * @version 1.0
 */
class ExportCsv extends ActiveRecordCsv
{
    ...
    protected function getRow(ActiveRecord $model)
    {
        return [
            $model->id,
            isset($model->attributeTypeI18ns[0]) ? $model->attributeTypeI18ns[0]->value : '',
