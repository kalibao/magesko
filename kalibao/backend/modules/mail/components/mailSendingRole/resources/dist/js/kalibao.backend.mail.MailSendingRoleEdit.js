...
(function ($) {
   ...
   * @constructor
   */
  $.kalibao.backend.mail.MailSendingRoleEdit = function (args) {
    for (var i in args) {
      if (this[i] !== undefined) {
        this[i] = args[i];
      }
   ...
   */
  $.kalibao.backend.mail.MailSendingRoleEdit.prototype = Object.create($.kalibao.backend.crud.Edit.prototype);

  /**
   * Init actions events
   */
  $.kalibao.backend.mail.MailSendingRoleEdit.prototype.initActionsEvents = function () {
    var self = this;
   ...
   * Submit
   */
  $.kalibao.backend.mail.MailSendingRoleEdit.prototype.submit = function () {
    var self = this;
