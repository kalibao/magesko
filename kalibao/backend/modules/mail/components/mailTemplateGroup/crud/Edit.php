...
class Edit extends \kalibao\common\components\crud\Edit
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setCreateTitle(Yii::t('kalibao.backend', 'mail_mail_template_group_create_title'));
        $this->setUpdateTitle(Yii::t('kalibao.backend', 'mail_mail_template_group_update_title'));
        ...
        $items[] = new InputField([
            ...
            'options' => [
                'class' => 'form-control input-sm link_mail_template_group_title',
                'maxlength' => true,
