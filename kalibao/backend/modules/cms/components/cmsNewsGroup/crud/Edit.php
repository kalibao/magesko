...
namespace kalibao\backend\modules\cms\components\cmsNewsGroup\crud;
 ...
 * Class Edit
 *
 * @package kalibao\backend\modules\cms\components\cmsNewsGroup\crud
 * @version 1.0
...
class Edit extends \kalibao\common\components\crud\Edit
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setCreateTitle(Yii::t('kalibao.backend', 'cms_news_group_create_title'));
        $this->setUpdateTitle(Yii::t('kalibao.backend', 'cms_news_group_update_title'));
        ...
        $items[] = new InputField([
            ...
            'options' => [
                'class' => 'form-control input-sm link_cms_news_group_title',
                'maxlength' => true,
