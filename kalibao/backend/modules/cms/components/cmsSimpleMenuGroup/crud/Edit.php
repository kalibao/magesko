...
namespace kalibao\backend\modules\cms\components\cmsSimpleMenuGroup\crud;
 ...
 * Class Edit
 *
 * @package kalibao\backend\modules\cms\components\cmsSimpleMenuGroup\crud
 * @version 1.0
...
class Edit extends \kalibao\common\components\crud\Edit
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setCreateTitle(Yii::t('kalibao.backend', 'cms_simple_menu_group_create_title'));
        $this->setUpdateTitle(Yii::t('kalibao.backend', 'cms_simple_menu_group_update_title'));
