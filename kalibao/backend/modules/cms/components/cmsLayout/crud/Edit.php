...
class Edit extends \kalibao\common\components\crud\Edit
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setCreateTitle(Yii::t('kalibao.backend', 'cms_layout_create_title'));
        $this->setUpdateTitle(Yii::t('kalibao.backend', 'cms_layout_update_title'));
        ...
        $items[] = new InputField([
            ...
            'options' => [
                'class' => 'form-control input-sm link_cms_layout_name',
                'maxlength' => true,
