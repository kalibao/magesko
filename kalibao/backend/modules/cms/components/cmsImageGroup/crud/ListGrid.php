...
namespace kalibao\backend\modules\cms\components\cmsImageGroup\crud;
 ...
 * Class ListGrid
 *
 * @package kalibao\backend\modules\cms\components\cmsImageGroup\crud
 * @version 1.0
...
class ListGrid extends \kalibao\common\components\crud\ListGrid
{
    ...
    public function init()
    {
        ...
        // set titles
        $this->setTitle(Yii::t('kalibao.backend', 'cms_image_group_list_title'));
        ...
        $this->setGridHeadFilters([
            new InputField([
                'model' => $model,
                'attribute' => 'cms_image_group_i18n_title',
